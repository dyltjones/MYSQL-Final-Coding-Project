...
public class ProjectsApp {
     ...
     * the requested operation. It repeats until the user request that the
    ...
    /**
     * Prints a prompt on the console and then gets the users input from the
     * console. If the user enters nothing {@code null} is returned. Othersie, the
